...
fn main() {
    ...
    if debug_mode {
        ...
        for column in &v {
            vec_datatypes.push(get_col_data_type(column))
        }
...
mod tests {
    ...
    fn test_is_na() {
        ...
        assert_eq!(is_na("missing"), true);
        assert_eq!(is_na("na"), true);
        assert_eq!(is_na("1"), false);
        assert_eq!(is_na("0"), false);
    }
    ...
    fn test_is_negative_number() {
        ...
        assert_eq!(is_negative_number("-12345   "), true);
        assert_eq!(is_negative_number("   -12345   "), true);
        assert_eq!(is_negative_number("-12.345"), true);
        assert_eq!(is_negative_number("   -12.345"), true);
        assert_eq!(is_negative_number("-12.345   "), true);
        assert_eq!(is_negative_number("   -12.345   "), true);
        assert_eq!(is_negative_number("0.0"), false);
        assert_eq!(is_negative_number("0."), false);
        assert_eq!(is_negative_number("text"), false);
        assert_eq!(is_negative_number("-123.123.123"), false);
    }
    ...
    fn test_scientific_notation_preserve() {
        ...
        let result_preserve = format_strings(&columns[1], 2, 20, 3, true, 13);
        ...
        let result_no_preserve = format_strings(&columns[1], 2, 20, 3, false, 13);
    ...
    fn test_scientific_notation_auto_convert() {
        ...
        let result_auto = format_strings(&columns[1], 2, 20, 3, false, 8);
        ...
        let result_no_auto = format_strings(&columns[1], 2, 20, 3, false, 20);
    ...
    fn test_scientific_notation_combined_flags() {
        ...
        let result_both = format_strings(&columns[1], 2, 25, 3, true, 10);
